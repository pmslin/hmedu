...
class __TwigTemplate_7bd020335e4cdecb33f0fd8fa1607d09a48d890b7bbf40fed5842c832fe62db2 extends Twig_Template
{
...
\t";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["metas"]) ? $context["metas"] : null), "tabs", array()));
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["key"] => $context["tab"]) {
            if ((!twig_in_filter($context["key"], array(0 => "material", 1 => "threads")) || ((array_key_exists("navMember", $context)) ? (_twig_default_filter((isset($context["navMember"]) ? $context["navMember"] : null), null)) : (null)))) {
                // line 3
                echo "\t\t";
                if ((isset($context["mobile"]) ? $context["mobile"] : null)) {
                    // line 4
                    echo "\t\t\t";
                    if (( !((array_key_exists("member", $context)) ? (_twig_default_filter((isset($context["member"]) ? $context["member"] : null), null)) : (null)) && ($this->getAttribute($context["loop"], "index", array()) <= 3))) {
                        // line 5
...
\t\t\t\t\t\t\t";
                        ...
                        if (((array_key_exists("member", $context)) ? (_twig_default_filter((isset($context["member"]) ? $context["member"] : null), false)) : (false))) {
                            // line 9
                            echo "\t\t\t\t\t\t\t\thref=\"";
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("my_course_show", array("id" => $this->getAttribute((isset($context["course"]) ? $context["course"] : null), "id", array()), "tab" => $context["key"], "previewAs" => (isset($context["previewAs"]) ? $context["previewAs"] : null))), "html", null, true);
                            echo "\"
\t\t\t\t\t\t\t";
                        } else {
                            // line 11
                            echo "\t\t\t\t\t\t\t\thref=\"";
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("course_show", array("id" => $this->getAttribute((isset($context["course"]) ? $context["course"] : null), "id", array()), "tab" => $context["key"], "previewAs" => (isset($context["previewAs"]) ? $context["previewAs"] : null))), "html", null, true);
                            echo "\"
\t\t\t\t\t\t\t";
                        }
                        // line 13
...
\t\t\t\t\t\t";
                        // line 15
                        if ((($context["key"] == "tasks") && ((array_key_exists("categoryTag", $context)) ? (_twig_default_filter((isset($context["categoryTag"]) ? $context["categoryTag"] : null), null)) : (null)))) {
                            // line 16
                            echo "\t\t\t\t\t\t\t<span class=\"badge badge-primary\">";
                            echo twig_escape_filter($this->env, (isset($context["categoryTag"]) ? $context["categoryTag"] : null), "html", null, true);
                            echo "</span>
\t\t\t\t\t\t";
                        }
                        // line 18
...
\t\t";
    ...
    {
        return new Twig_Source("", "course/header/nav-tab-for-guest.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\course\\header\\nav-tab-for-guest.html.twig");
    }
}
