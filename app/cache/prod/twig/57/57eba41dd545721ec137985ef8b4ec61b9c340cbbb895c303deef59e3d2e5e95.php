...
class __TwigTemplate_40a17acc201bcc2de0ff517801829852d8ee6d0aefaabad079206c78b64798c2 extends Twig_Template
{
...
<div class=\"text-right buy-btn-group visible-xs visible-sm\">
  <span class=\"mr20\">完成任务：";
        // line 36
        echo twig_escape_filter($this->env, (isset($context["taskResultCount"]) ? $context["taskResultCount"] : null), "html", null, true);
        echo " / ";
        echo twig_escape_filter($this->env, (isset($context["taskCount"]) ? $context["taskCount"] : null), "html", null, true);
        echo "</span>
  ";
        // line 37
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["toLearnTasks"]) ? $context["toLearnTasks"] : null));
        $context['loop'] = array(
        ...
        href=\"";
                // line 40
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("course_task_show", array("courseId" => $this->getAttribute((isset($context["course"]) ? $context["course"] : null), "id", array()), "id" => $this->getAttribute($context["toLearnTask"], "id", array()))), "html", null, true);
                echo "\">
        ";
                // line 41
                if (((isset($context["taskResultCount"]) ? $context["taskResultCount"] : null) < 1)) {
                    // line 42
                    echo "          开始学习
        ";
                } else {
    ...
    {
        return new Twig_Source("", "course/header/header-for-member-responsive.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\course\\header\\header-for-member-responsive.html.twig");
    }
}
