...
class __TwigTemplate_92bb46923dc703c087601139c9444173f2b06aa18376b644f2fe514579014db3 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $asm89Key1 = $asm89CacheStrategy1->generateKey(("course-announcements-block/course/" . (isset($context["courseId"]) ? $context["courseId"] : null)), 600        );
        ...
        if ($asm89CacheBody1 === false) {
            ob_start();
                ...
                // line 3
                echo "  ";
                $context["announcements"] = $this->env->getExtension('AppBundle\Twig\DataExtension')->getData("CourseAnnouncements", array("courseId" => (isset($context["courseId"]) ? $context["courseId"] : null), "count" => 10));
                // line 4
                echo "  ";
      ...
      <div class=\"swiper-container\">
        ...
        ";
            ...
            ";
                        // line 12
                        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans(_twig_default_filter($this->env->getExtension('AppBundle\Twig\WebExtension')->subTextFilter($this->getAttribute($context["announcement"], "content", array()), 50), "<span class=\"text-warning\">(请点击查看)</span>"));
                        echo "</a>
          </div>
        ";
                    }
...
";
    ...
    {
        return array (  71 => 20,  60 => 15,  51 => 12,  46 => 10,  43 => 9,  39 => 8,  34 => 5,  31 => 4,  28 => 3,  25 => 2,  19 => 1,);
    }
    ...
    {
        return new Twig_Source("", "course/announcement/block.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\course\\announcement\\block.html.twig");
    }
}
