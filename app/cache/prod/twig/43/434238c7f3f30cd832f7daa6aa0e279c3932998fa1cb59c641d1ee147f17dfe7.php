...
class __TwigTemplate_9f50691d1c852bb63a836f3092530f5d6df7ac2c705c09ccf9dbfafbdc254fd0 extends Twig_Template
{
  ...
  <div class=\"col-md-2 control-label\">
    <label for=\"testpaper-percentage-field\">";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("生成方式"), "html", null, true);
        echo "</label>
  </div>
  <div class=\"col-md-8 controls radios\">
    ";
        // line 6
        echo $this->env->getExtension('AppBundle\Twig\HtmlExtension')->radios("mode", array("rand" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("随机生成"), "difficulty" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("按难易程度")), "rand");
        echo "
  </div>
</div>
...
<div class=\"form-group hidden\" id=\"difficulty-form-group\">
  <div class=\"col-md-2 control-label\">
    <label for=\"testpaper-percentage-field\">";
        // line 12
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("试卷难度"), "html", null, true);
        echo "</label>
  </div>
  <div class=\"col-md-8 controls mtm\">
    ...
    <span class=\"color-warning\">";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("如果某个难度的题目数不够，将会随机选择题目来补充。"), "html", null, true);
        echo "</span>
  </div>
</div>
...
<div class=\"form-group\">
  <div class=\"col-md-2 control-label\"><label for=\"testpaper-range-field\">";
        // line 26
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("出题范围"), "html", null, true);
        echo "</label></div>
  <div class=\"col-md-8 controls\">
    ";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("course_set_manage_question_check_num", array("courseSetId" => $this->getAttribute((isset($context["courseSet"]) ? $context["courseSet"] : null), "id", array()))), "html", null, true);
        echo "\">
      <option value=\"0\" ";
        // line 45
      ...
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["course"]) {
            if ($context["course"]) {
                ...
                echo "\" ";
                if (((($this->getAttribute((isset($context["range"]) ? $context["range"] : null), "courseId", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["range"]) ? $context["range"] : null), "courseId", array()), 0)) : (0)) == $this->getAttribute($context["course"], "id", array()))) {
                    echo "selected";
                }
                echo ">";
...
<div class=\"form-group\">
  ...
  <div class=\"col-md-2 control-label\"><label class=\"control-label-required\">";
        // line 61
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("题目设置"), "html", null, true);
        echo "</label></div>
  <ul class=\"col-md-10 controls\" id=\"testpaper-question-options\">
    ";
        ...
        <input type=\"text\" class=\"form-control width-input width-input-mini item-number\" name=\"counts[";
            ...
            if (((($this->getAttribute($this->getAttribute((isset($context["questionNums"]) ? $context["questionNums"] : null), $context["type"], array(), "array", false, true), "questionNum", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute((isset($context["questionNums"]) ? $context["questionNums"] : null), $context["type"], array(), "array", false, true), "questionNum", array()), 0)) : (0)) == 0)) {
                echo " disabled ";
            }
            echo " />/
        <span class=\"text-info question-num\" role=\"questionNum\" type=\"";
            ...
            echo twig_escape_filter($this->env, $context["type"], "html", null, true);
            echo "\" >";
            echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute((isset($context["questionNums"]) ? $context["questionNums"] : null), $context["type"], array(), "array", false, true), "questionNum", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute((isset($context["questionNums"]) ? $context["questionNums"] : null), $context["type"], array(), "array", false, true), "questionNum", array()), 0)) : (0)), "html", null, true);
            echo "</span>

        <span class=\"mlm\">";
            // line 71
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("题目分值"), "html", null, true);
            echo ":</span>
        ...
        ";
            ...
            if ((($this->getAttribute($context["config"], "hasMissScore", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($context["config"], "hasMissScore", array()), null)) : (null))) {
                // line 75
                echo "          <span class=\"mlm\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("漏选分值"), "html", null, true);
                echo ":</span>
...
";
    ...
    {
        return new Twig_Source("", "testpaper/manage/create-build-info.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\testpaper\\manage\\create-build-info.html.twig");
    }
}
