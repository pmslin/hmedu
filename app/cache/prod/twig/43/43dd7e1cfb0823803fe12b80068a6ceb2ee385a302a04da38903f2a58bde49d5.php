...
class __TwigTemplate_9c45685907095dc956c3787e62689a296109ea4789a428052987783beef9c440 extends Twig_Template
{
...
<div class=\"alert alert-info\">
  <h5><strong>";
        // line 5
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("请先完成以下设置，才能创建课程："), "html", null, true);
        echo "</strong></h5>
  <ol>
    <li>";
        // line 7
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("设置头像。"), "html", null, true);
        echo "
      ";
        // line 8
        if ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array()), "largeAvatar", array())) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("已完成"), "html", null, true);
            echo "</span> </li>
      ";
        } else {
            // line 11
      ...
      ";
        ...
        // line 13
        echo "    <li>";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("设置头衔 、自我介绍。"), "html", null, true);
        echo "
      ";
        // line 14
...
<form id=\"user-profile-form\" class=\"form-horizontal\" method=\"post\" action=\"";
  ...
  <div class=\"form-group\">
    <label class=\"col-md-2 control-label\" for=\"profile_avatar\"><b>";
        // line 27
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("用户头像"), "html", null, true);
        echo "</b></label>
  ...
  <div class=\"form-group\">
    ...
    <div class=\"controls col-md-8 controls\">
      ";
        // line 38
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("<p class=\"help-block\">你可以上传JPG、GIF或PNG格式的文件，文件大小不能超过<strong>2M</strong>。</p>");
        echo "
    </div>
  </div>
  ...
  ";
        // line 53
        $context["user"] = $this->env->getExtension('AppBundle\Twig\DataExtension')->getData("UserandProfiles", array("userId" => $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array()), "id", array())));
        // line 54
  ...
  <input type=\"hidden\" name=\"_csrf_token\" value=\"";
    ...
    {
        return new Twig_Source("", "settings/user-profile.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\settings\\user-profile.html.twig");
    }
}
