...
class __TwigTemplate_42fae932cab218ae7ea66f075b5bdc653ad1b92a704978d30646f3faa1598257 extends Twig_Template
{
...
";
        // line 6
        $context["consultQqs"] = $this->env->getExtension('AppBundle\Twig\WebExtension')->arrayFilter((($this->getAttribute((isset($context["consult"]) ? $context["consult"] : null), "qq", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["consult"]) ? $context["consult"] : null), "qq", array()))) : ("")), array(0 => "name", 1 => "number"));
        // line 7
        $context["consultQqGroups"] = $this->env->getExtension('AppBundle\Twig\WebExtension')->arrayFilter((($this->getAttribute((isset($context["consult"]) ? $context["consult"] : null), "qqgroup", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["consult"]) ? $context["consult"] : null), "qqgroup", array()))) : ("")), array(0 => "name", 1 => "number"));
        // line 8
        $context["consultPhones"] = $this->env->getExtension('AppBundle\Twig\WebExtension')->arrayFilter((($this->getAttribute((isset($context["consult"]) ? $context["consult"] : null), "phone", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["consult"]) ? $context["consult"] : null), "phone", array()))) : ("")), array(0 => "name", 1 => "number"));
        // line 9
        echo "
<!-- 侧边栏快捷操作 -->
<div class=\"es-bar hidden-xs\">
  ...
  ";
    ...
    {
        return new Twig_Source("", "es-bar/index.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\es-bar\\index.html.twig");
    }
}
