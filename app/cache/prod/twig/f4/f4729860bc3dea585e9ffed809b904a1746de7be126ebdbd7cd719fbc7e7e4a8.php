...
class __TwigTemplate_917e2c889a50631f41417f1478f8258f2c7d4860674b528aeedfb9b8c879efab extends Twig_Template
{
 ...
 ";
        // line 23
        $this->loadTemplate("org/parts/table-body-td.html.twig", "admin/user/user-table-tr.html.twig", 23)->display(array_merge($context, array("orgCode" => $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "orgCode", array()))));
        // line 24
        echo "  <td>
    ";
        // line 25
...
(isset($context["profile"]) ? $context["profile"] : null), "mobile", array())) {
  ...
  <td>
    ...
    ";
        // line 53
        echo twig_escape_filter($this->env, $this->env->getExtension('AppBundle\Twig\WebExtension')->getConvertIP($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "createdIp", array())), "html", null, true);
        echo "
  </span>
    <span></span>
  </td>
  <td>
    ...
    ";
        // line 68
        echo twig_escape_filter($this->env, $this->env->getExtension('AppBundle\Twig\WebExtension')->getConvertIP($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "loginIp", array())), "html", null, true);
        echo "
  </span>
  </td>
  <td>
    <div class=\"btn-group\">
      ...
      ";
        // line 74
        $this->loadTemplate("admin/role/templates/group-button.html.twig", "admin/user/user-table-tr.html.twig", 74)->display(array_merge($context, array("parentCode" => "admin_user_manage", "group" => "groupButton", "user" => (isset($context["user"]) ? $context["user"] : null))));
        // line 75
        echo "    </div>
  </td>
</tr>
...
";
    ...
    {
        return new Twig_Source("", "admin/user/user-table-tr.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\admin\\user\\user-table-tr.html.twig");
    }
}
