...
class __TwigTemplate_467cefadc53e607a144905269ba725b20969104a907d12f06a52381ff17efd0c extends Twig_Template
{
  ...
  <div class=\"well well-sm mtl\">
    <form id=\"message-search-form\" class=\"form-inline\" action=\"\" method=\"get\" novalidate>
      ";
        // line 12
        $this->loadTemplate("org/org-tree-select.html.twig", "admin/course-set/index.html.twig", 12)->display(array_merge($context, array("orgCode" => $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "orgCode"), "method"), "modal" => "list")));
        // line 13
        echo "
      <div class=\"form-group\">
        <select style=\"max-width:150px;\" class=\"form-control\" name=\"categoryId\">
          ";
        // line 16
        echo $this->env->getExtension('AppBundle\Twig\HtmlExtension')->selectOptions($this->env->getExtension('AppBundle\Twig\WebExtension')->getCategoryChoices("course"), $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "query", array()), "get", array(0 => "categoryId"), "method"), $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("课程分类"));
        echo "
        </select>
      </div>
      <div class=\"form-group\">
  ...
  <p class=\"text-muted\">
    <span class=\"mrl\">";
        ...
        echo twig_escape_filter($this->env, (isset($context["searchCourseSetsNum"]) ? $context["searchCourseSetsNum"] : null), "html", null, true);
        echo "</strong> ";
    ...
    <span class=\"mrl\">";
        ...
        echo "<strong class=\"inflow-num\">";
        echo twig_escape_filter($this->env, (isset($context["publishedCourseSetsNum"]) ? $context["publishedCourseSetsNum"] : null), "html", null, true);
        echo "</strong> ";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("个"), "html", null, true);
        echo "</span>
    <span class=\"mrl\">";
        ...
        echo twig_escape_filter($this->env, (isset($context["closedCourseSetsNum"]) ? $context["closedCourseSetsNum"] : null), "html", null, true);
        echo "</strong> ";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("个"), "html", null, true);
        echo "</span>
    <span class=\"mrl\">";
        ...
        echo "<strong class=\"outflow-num\">";
        echo twig_escape_filter($this->env, (isset($context["unPublishedCourseSetsNum"]) ? $context["unPublishedCourseSetsNum"] : null), "html", null, true);
        echo "</strong> ";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("个"), "html", null, true);
        echo "</span>
  </p>
...
";
    ...
    {
        return new Twig_Source("", "admin/course-set/index.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\admin\\course-set\\index.html.twig");
    }
}
