...
class __TwigTemplate_154a6c1966286f26b8a61087817ecbbe69df88ab6773cd4f0b98cbd8481c06fd extends Twig_Template
{
    ...
    ";
            ...
            // line 10
            echo "      action=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("announcement_add", array("targetType" => (isset($context["targetType"]) ? $context["targetType"] : null), "targetId" => $this->getAttribute((isset($context["targetObject"]) ? $context["targetObject"] : null), "id", array()))), "html", null, true);
            echo "\"
    ";
        }
        // line 12
    ...
    ";
        ...
        <div class=\"col-md-2 control-label\">
          <label for=\"startTime\">";
            // line 19
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("选择计划"), "html", null, true);
            echo "</label>
        </div>
          ...
          <select class=\"form-control\" name=\"targetId\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["plan"]) {
                if ($context["plan"]) {
                    ...
                    echo "\" ";
                    if ((($this->getAttribute($context["plan"], "id", array()) == (($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "id", array()), 0)) : (0))) || ($this->getAttribute($context["plan"], "id", array()) == (($this->getAttribute((isset($context["announcement"]) ? $context["announcement"] : null), "targetId", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["announcement"]) ? $context["announcement"] : null), "targetId", array()), 0)) : (0))))) {
                        echo "selected";
                    }
                    echo ">";
      ...
      <div class=\"col-md-9 controls\">
        <div class=\"checkbox\">
          <label>
            ...
            // line 65
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("给%user_name%发送系统通知", array("%user_name%" => (($this->getAttribute((isset($context["default"]) ? $context["default"] : null), "user_name", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["default"]) ? $context["default"] : null), "user_name", array()), $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("学员"))) : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("学员"))))), "html", null, true);
            echo "
          </label>
        </div>
      </div>
...
";
    ...
    public function block_footer($context, array $blocks = array())
    {
        ...
        echo "</button>
  <button type=\"button\" class=\"btn btn-primary pull-right js-save-btn\" data-toggle=\"form-submit\" data-target=\"#announcement-write-form\" data-loading-text=\"";
        // line 77
...
";
    ...
    {
        return new Twig_Source("", "course/announcement/write-modal.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\course\\announcement\\write-modal.html.twig");
    }
}
