...
class __TwigTemplate_76f07474a367accd3b6ef8bab5006d6b1f81c02cb5ab860b92203c23fff0b8a6 extends Twig_Template
{
    ...
    {
        // line 1
        $context["tabMenus"] = $this->env->getExtension('AppBundle\Twig\PermissionExtension')->getSubPermissions((($this->getAttribute($this->env->getExtension('AppBundle\Twig\PermissionExtension')->getParentPermission((isset($context["menu"]) ? $context["menu"] : null)), "code", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->env->getExtension('AppBundle\Twig\PermissionExtension')->getParentPermission((isset($context["menu"]) ? $context["menu"] : null)), "code", array()), null)) : (null)));
        // line 2
...
";
    ...
    {
        return new Twig_Source("", "admin/role/templates/tabs.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\admin\\role\\templates\\tabs.html.twig");
    }
}
