...
class __TwigTemplate_a9ef025120c62880961e982e2b1312f903dff7448fa51519cd054726c21785c9 extends Twig_Template
{
  ...
  ";
      ...
      <td>
        <a class=\"link-primary\"
           target=\"_blank\" href=\"";
            // line 15
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("course_show", array("id" => $this->getAttribute($this->getAttribute((isset($context["courseSets"]) ? $context["courseSets"] : null), $this->getAttribute($context["memberCount"], "courseSetId", array()), array(), "array"), "defaultCourseId", array()))), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["courseSets"]) ? $context["courseSets"] : null), $this->getAttribute($context["memberCount"], "courseSetId", array()), array(), "array"), "title", array()), "html", null, true);
            echo "</a>
      </td>
  ...
  ";
    ...
    {
        return new Twig_Source("", "admin/default/parts/course-explore-table.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\admin\\default\\parts\\course-explore-table.html.twig");
    }
}
