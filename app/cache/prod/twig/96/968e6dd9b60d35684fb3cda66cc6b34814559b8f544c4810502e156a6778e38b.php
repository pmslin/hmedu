...
class __TwigTemplate_0f2cab230d5af75d0a44c2ce2521b1761782b54f3e5cf051dd79e500f0c8ed2b extends Twig_Template
{
...
";
  ...
  <td>
    ...
    ";
        ...
        if (((isset($context["filter"]) ? $context["filter"] : null) == "classroom")) {
            // line 12
            echo "      ";
            $context["classroom"] = (($this->getAttribute((isset($context["classrooms"]) ? $context["classrooms"] : null), $this->getAttribute((isset($context["courseSet"]) ? $context["courseSet"] : null), "id", array()), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["classrooms"]) ? $context["classrooms"] : null), $this->getAttribute((isset($context["courseSet"]) ? $context["courseSet"] : null), "id", array()), array(), "array"), null)) : (null));
            // line 13
            echo "      ";
    ...
    ";
        // line 22
        if ($this->getAttribute((isset($context["courseSet"]) ? $context["courseSet"] : null), "recommended", array())) {
            // line 23
            ...
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["courseSet"]) ? $context["courseSet"] : null), "recommendedTime", array()), "Y-m-d"), "html", null, true);
            echo "
        / ";
            // line 24
            ...
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["courseSet"]) ? $context["courseSet"] : null), "recommendedSeq", array()), "html", null, true);
            echo "</span>
    ";
        }
        // line 26
  ...
  ";
        // line 29
        $this->loadTemplate("org/parts/table-body-td.html.twig", "admin/course-set/tr.html.twig", 29)->display(array_merge($context, array("orgCode" => $this->getAttribute((isset($context["courseSet"]) ? $context["courseSet"] : null), "orgCode", array()))));
        // line 30
        echo "  ";
      ...
      <span class=\"text-info\">";
            // line 32
            echo $this->env->getExtension('Codeages\PluginBundle\Twig\DictExtension')->getDictText("courseSerializeMode", $this->getAttribute((isset($context["courseSet"]) ? $context["courseSet"] : null), "serializeMode", array()));
            echo "</span>
    </td>
    ";
            // line 34
    ...
    ";
            ...
            if (((isset($context["filter"]) ? $context["filter"] : null) == "vip")) {
                // line 46
                echo "      ";
                $context["levels"] = $this->getAttribute((isset($context["courseSet"]) ? $context["courseSet"] : null), "levels", array(), "array");
                // line 47
                echo "      ";
                $context["length"] = twig_length_filter($this->env, (isset($context["levels"]) ? $context["levels"] : null));
                // line 48
                echo "      ";
      ...
      ";
                    ...
                    // line 51
                    echo "        <td>";
                    echo twig_escape_filter($this->env, $this->getAttribute(twig_first($this->env, (isset($context["levels"]) ? $context["levels"] : null)), "name", array()), "html", null, true);
                    echo "
          ";
                    // line 52
                    if (((isset($context["length"]) ? $context["length"] : null) > 1)) {
                        // line 53
                        echo "            <br>
  ...
  <td> ";
        // line 61
        echo $context["dict_macro"]->getcourseStatus($this->getAttribute((isset($context["courseSet"]) ? $context["courseSet"] : null), "status", array()));
        echo "</td>
  <td>
    ";
        // line 63
    ...
    <span class=\"text-muted text-sm\">";
        // line 65
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["courseSet"]) ? $context["courseSet"] : null), "createdTime", array()), "Y-n-d H:i"), "html", null, true);
        echo "</span>
  </td>
  <td>
    <div class=\"btn-group\">
      ...
      ";
        ...
        // line 74
        echo "      ";
        $this->loadTemplate("admin/role/templates/group-button.html.twig", "admin/course-set/tr.html.twig", 74)->display(array_merge($context, array("parentCode" => "admin_course_manage", "group" => "groupButton", "courseSet" => (isset($context["courseSet"]) ? $context["courseSet"] : null))));
        // line 75
        echo "    </div>
  </td>
</tr>";
    ...
    {
        return new Twig_Source("", "admin/course-set/tr.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\admin\\course-set\\tr.html.twig");
    }
}
