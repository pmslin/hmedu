...
class __TwigTemplate_73dca6ba7a705f07486147c41415bb472536f19cc02e8cd15a0b1548a2bedb17 extends Twig_Template
{
...
\t";
        // line 7
        if (($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "learnMode", array()) == "freeMode")) {
            // line 8
            echo "\t<!-- 2、加入后：自由式学习 -->
\t\t";
            // line 9
            ...
            // line 10
            echo "\t";
        } elseif (($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "learnMode", array()) == "lockMode")) {
            // line 11
            echo "\t<!-- 3、加入后：任务式学习 -->
\t\t";
            // line 12
    ...
    {
        return new Twig_Source("", "course/header/header-for-member.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\course\\header\\header-for-member.html.twig");
    }
}
