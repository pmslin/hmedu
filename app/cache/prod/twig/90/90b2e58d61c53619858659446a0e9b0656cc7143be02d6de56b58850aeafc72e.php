...
class __TwigTemplate_2529f7341048305152dee2afdc4f364a764892f816c9c6198d92e0b3c057b839 extends Twig_Template
{
  ...
  <ul class=\"task-list task-list-md task-list-hover\">
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["courseItems"]) ? $context["courseItems"] : null));
        $context['loop'] = array(
...
$context["item"], "type", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($context["item"], "type", array()), null)) : (null)) == "lesson")) {
                ...
                // line 15
                echo "        ";
                $context["index"] = (($this->getAttribute($this->getAttribute((isset($context["tasks"]) ? $context["tasks"] : null), "lesson", array(), "any", false, true), "number", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute((isset($context["tasks"]) ? $context["tasks"] : null), "lesson", array(), "any", false, true), "number", array()), null)) : (null));
                // line 16
                echo "
        ";
                // line 17
          ...
          ";
                        ...
                        // line 20
                        echo "          ";
                        $context["file"] = (($this->getAttribute((isset($context["files"]) ? $context["files"] : null), $this->getAttribute($this->getAttribute($context["task"], "activity", array()), "id", array()), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["files"]) ? $context["files"] : null), $this->getAttribute($this->getAttribute($context["task"], "activity", array()), "id", array()), array(), "array"), null)) : (null));
                        // line 21
...
$context["task"], "result", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($context["task"], "result", array()), null)) : (null)) || twig_test_empty((isset($context["member"]) ? $context["member"] : null)))) {
                            // line 26
...
$context["task"], "result", array()), "status", array()) == "finish")) {
            ...
            ";
                        // line 34
                        if ((($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "status", array()) == "published") && ($this->getAttribute($context["task"], "status", array()) == "published"))) {
                            // line 35
                            echo "
              ";
                            // line 36
...
(isset($context["course"]) ? $context["course"] : null), "tryLookable", array()) && ($this->getAttribute($context["task"], "type", array()) == "video")) && ((($this->getAttribute((isset($context["file"]) ? $context["file"] : null), "storage", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["file"]) ? $context["file"] : null), "storage", array()), "")) : ("")) == "cloud"))) {
                                    // line 55
...
$context["task"], "isFree", array()) && ((($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "parentId", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "parentId", array()), 0)) : (0)) == 0))) {
                                    // line 59
                                    echo "                  ";
                                    if ($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "isFree", array())) {
                                        // line 60
                                        echo "                    <a style=\"margin-top:-8px\" class=\"btn btn-primary ";
                                        if (((array_key_exists("previewAs", $context)) ? (_twig_default_filter((isset($context["previewAs"]) ? $context["previewAs"] : null))) : (""))) {
                                            echo "disabled";
                                        }
                                        echo "\"
                      ";
                                        // line 61
                                        if ($this->env->getExtension('AppBundle\Twig\CourseExtension')->isBuyCourseFromModal($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "id", array()))) {
                                            // line 62
                                            echo "                      href=\"#modal\"
                      data-toggle=\"modal\"
                      data-url=\"";
...
";
    ...
    {
        return new Twig_Source("", "course/task-list/default-task-list.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\course\\task-list\\default-task-list.html.twig");
    }
}
