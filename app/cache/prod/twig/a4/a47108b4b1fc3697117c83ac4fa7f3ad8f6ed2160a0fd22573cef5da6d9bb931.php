...
class __TwigTemplate_6272b16da1fb812058ae74e005ed91329428bacb59fb82140a0dfd6e91834d7e extends Twig_Template
{
    ...
    <button class=\"btn btn-warning btn-sm cancel-refund\" data-url=\"";
            // line 7
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("order_cancel_refund", array("id" => $this->getAttribute((isset($context["course"]) ? $context["course"] : null), "id", array()), "targetType" => "course")), "html", null, true);
  ...
  ";
    ...
    public function block_course_member_exit($context, array $blocks = array())
    {
        // line 13
        echo "\t";
        if ((((($this->getAttribute((isset($context["member"]) ? $context["member"] : null), "id", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["member"]) ? $context["member"] : null), "id", array()), false)) : (false)) && ($this->getAttribute((isset($context["member"]) ? $context["member"] : null), "role", array()) != "teacher")) &&  !(($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "parentId", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "parentId", array()), 0)) : (0)))) {
            // line 14
            echo "\t\t<li>
...
\t";
    ...
    {
        return new Twig_Source("", "course/header/header-for-member-layout.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\course\\header\\header-for-member-layout.html.twig");
    }
}
