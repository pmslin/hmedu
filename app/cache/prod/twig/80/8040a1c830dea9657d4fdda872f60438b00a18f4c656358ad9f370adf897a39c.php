...
class __TwigTemplate_50323b7143a58f3d319287bd6a23248f5c09c6d56ad50e44eb2f32961915338c extends Twig_Template
{
    ...
    {
        // line 1
        $context["current_route"] = $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method");
        // line 2
        echo "
";
        // line 3
        if (((((isset($context["current_route"]) ? $context["current_route"] : null) != "admin_app_upgrades") && $this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array())) && $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array()), "isSuperAdmin", array(), "method"))) {
            // line 4
            echo "  ";
          ...
          <div class=\"modal-body\">
            <div class=\"update-redmine-body\">
              ...
              <div class=\"mll mtl mrl clearfix\">
                ...
                $context['_seq'] = twig_ensure_traversable((isset($context["notifies"]) ? $context["notifies"] : null));
                foreach ($context['_seq'] as $context["type"] => $context["apps"]) {
                    // line 20
                    echo "                  <p class=\"color-primary mbl mtl\">请即刻升级以下";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["dispalys"]) ? $context["dispalys"] : null), $context["type"], array(), "array"), "html", null, true);
  ...
  ";
    ...
    {
        return new Twig_Source("", "admin/plugin-upgrade-notify-modal.html.twig", "E:\\xampp\\htdocs\\pro\\edusohoty\\app\\Resources\\views\\admin\\plugin-upgrade-notify-modal.html.twig");
    }
}
