...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['assets._version__default'] = new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('8.0.16', '%s?%s');
    }
    ...
    {
        return $this->services['codeages_plugin.dict_collector'] = new \Codeages\PluginBundle\System\DictCollector(array(0 => ($this->targetDirs[3].'\\src\\AppBundle/Resources/config/dict.yml')), __DIR__, false);
    }
    ...
    {
        return $this->services['doctrine.orm.entity_manager'] = \Doctrine\ORM\EntityManager::create(array('driver' => 'pdo_mysql', 'user' => 'root', 'password' => '', 'dbname' => 'edusohoty', 'host' => '127.0.0.1', 'port' => 3306), $this->get('doctrine.entity_manager.config'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $y = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'lllfurb9r5cok04wwgkgo40soocc0k8', 'main', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    {
        $this->services['session.handler.pdo.connection'] = $instance = new \PDO('mysql:host=127.0.0.1;port=3306;dbname=edusohoty', 'root', '');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $a->addPath(($this->targetDirs[3].'\\src\\Topxia\\AdminBundle/Resources/views'), 'TopxiaAdmin');
        $a->addPath(($this->targetDirs[3].'\\src\\Topxia\\MobileBundleV2/Resources/views'), 'TopxiaMobileBundleV2');
        $a->addPath(($this->targetDirs[3].'\\vendor\\willdurand\\js-translation-bundle\\Bazinga\\Bundle\\JsTranslationBundle/Resources/views'), 'BazingaJsTranslation');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('lllfurb9r5cok04wwgkgo40soocc0k8');
    }
        ...
        return array(
            ...
            'kernel.bundles_metadata' => array(
                ...
                'EndroidQrCodeBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\vendor\\endroid\\qrcode-bundle\\src'),
                ...
                'BazingaJsTranslationBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\vendor\\willdurand\\js-translation-bundle\\Bazinga\\Bundle\\JsTranslationBundle'),
            ...
            'locale' => 'zh_CN',
            'secret' => 'lllfurb9r5cok04wwgkgo40soocc0k8',
            'webpack_base_url' => 'http://edusohoty.com',
            'user_partner' => 'none',
            'doctrine.config_paths' => array(
                'E:\\xampp\\htdocs\\pro\\edusohoty\\app/../vendor/bshaffer/oauth2-server-bundle/OAuth2/ServerBundle/Resources/config/doctrine' => 'OAuth2\\ServerBundle\\Entity',
            ),
            ...
            'kernel.secret' => 'lllfurb9r5cok04wwgkgo40soocc0k8',
